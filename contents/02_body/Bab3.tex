...
\begin{spacing}{1.5}
	...
	\begin{itemize}
		...
		\item \textbf{\textit{Input}}. Data-data terkait penelitian diunduh terlebih dahulu. Adapun data yang digunakan adalah data DMI, data oseanografi: arus laut, temperatur laut, salinitas, MLD, Chl-a, fluks air tawar, dan fluks panas bersih, dan data meteorologi: laju presipitasi dan tekanan angin.
		\item \textbf{\textit{Process}}. Setelah data tersedia, kemudian data diolah dengan cara melakukan pemetaan dan penggambaran data. Pada tahap ini akan dilakukan beberapa tahapan berikut.
		\begin{itemize}
			\item Prapemrosesan data, yaitu mempersiapkan data sebelum dipetakan dan digambar.
			\item Pemetaan data, yaitu proses pemetaan data yang telah disiapkan sebelumnya. 
			\item Pembersihan data, yaitu
			\item Penggambaran Data, yaitu
		\end{itemize}
